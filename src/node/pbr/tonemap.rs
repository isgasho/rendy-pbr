use rendy::{
    ...
    resource::{
        Buffer, BufferInfo, Escape, Handle, DescriptorSetLayout,
        Filter, ImageView, ImageViewInfo, ViewKind, WrapMode,
        Sampler, SamplerInfo
    },
    ...
    B: hal::Backend,
{
    ...
    fn build<'a>(
        ...
        let image_sampler = factory.create_sampler(SamplerInfo::new(Filter::Nearest, WrapMode::Clamp))?;
